...
#define Z_DIAG_PIN                          PG15  // Z+STOP
#define Z2_DIAG_PIN                         PG11  // Z2+STOP
#define E0_DIAG_PIN                         PG12  // E0DET Z-STOP
#define E1_DIAG_PIN                         PG13  // E1DET DET2
#define E2_DIAG_PIN                         PG14  // E2DET LEVEL
#define E3_DIAG_PIN                         PG9  // E3DET  X2-STOP

//
// Z Probe (when not Z_MIN_PIN)
//
#ifndef Z_MIN_PROBE_PIN
  #define Z_MIN_PROBE_PIN                   PG14
#endif
...
//
  ...
  #ifndef X_MIN_PIN
    #define X_MIN_PIN                 PG6  // X-STOP
  #endif
  #ifndef X_MAX_PIN
    #define X_MAX_PIN                PG9  // E0DET
  #endif
#else
  ...
  #ifndef Z_MIN_PIN
    #define Z_MIN_PIN                 PG11  // Z-STOP
  #endif
  #ifndef Z_MAX_PIN
    #define Z_MAX_PIN                PG15  // PWRDET
  #endif
#else
  #define Z_STOP_PIN                  Z2_DIAG_PIN  // Z-STOP
#endif
