...
typedef struct SettingsDataStruct {
  ...
  //
    ...
    bool DGUSDetectorFil_L;
    bool DGUSDetectorFil_R;
    bool DGUSTEMP_Protect;
    uint8_t e0tempmode;
    uint8_t e1tempmode;
  #endif
...
#include "../core/debug_out.h"
  ...
  bool MarlinSettings::save() {
    ...
    //
      ...
      EEPROM_WRITE(DGUSDetectorFil_L);
      EEPROM_WRITE(DGUSDetectorFil_R);
      EEPROM_WRITE(DGUSTEMP_Protect);
      EEPROM_WRITE(e0tempmode);
      EEPROM_WRITE(e1tempmode);
    #endif
  ...
  bool MarlinSettings::_load() {
    ...
    if (strncmp(version, stored_ver, 3) != 0) {
      ...
      //
        ...
        EEPROM_READ(DGUSDetectorFil_L);
        EEPROM_READ(DGUSDetectorFil_R);
        EEPROM_READ(DGUSTEMP_Protect);
        EEPROM_READ(e0tempmode);
        EEPROM_READ(e1tempmode);
      #endif
