...
//
  ...
  #define DISABLE_STEPPER_Z() NOOP//TERN(HAS_Z_ENABLE, Z_ENABLE_WRITE(!Z_ENABLE_ON), NOOP)
#endif
  ...
  #define DISABLE_STEPPER_Z2() NOOP//TERN(HAS_Z2_ENABLE, Z2_ENABLE_WRITE(!Z_ENABLE_ON), NOOP)
#endif
