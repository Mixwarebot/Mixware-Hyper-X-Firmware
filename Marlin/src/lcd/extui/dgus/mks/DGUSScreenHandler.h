...
public:
  ...
  static void HandleManualTemperature(DGUS_VP_Variable &var, void *val_ptr);
  static void Fan_Light_Ctrl(DGUS_VP_Variable &var, void *val_ptr);
  static void Babystep_Ctrl(DGUS_VP_Variable &var, void *val_ptr);
  static void Temperature_Ctrl(DGUS_VP_Variable &var, void *val_ptr);
  static void PREHEAT_CTRL(DGUS_VP_Variable &var, void *val_ptr);
  static void HandleJerk_MKS(DGUS_VP_Variable &var, void *val_ptr);
  static void HandleExtruderJerk_MKS(DGUS_VP_Variable &var, void *val_ptr);
  static void TempModeChange(DGUS_VP_Variable &var, void *val_ptr);
  ...
  static void HandleHeaterControl(DGUS_VP_Variable &var, void *val_ptr);
    ...
    static void MKS_ReloadingIn(DGUS_VP_Variable &var, void *val_ptr);
    static void MKS_ReloadingOut(DGUS_VP_Variable &var, void *val_ptr);
...
extern uint8_t e0tempmode;
extern uint8_t e1tempmode;
extern bool DGUSAutoTurnOff;
extern bool DGUSDetectorFil_L;
extern bool DGUSDetectorFil_R;
extern bool DGUSTEMP_Protect;
