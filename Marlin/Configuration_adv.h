 ...
 */
   ...
   */
  #define WATCH_CHAMBER_TEMP_PERIOD            150 // Seconds
 ...
 */
   ...
   */
  #define WATCH_COOLER_TEMP_PERIOD             150 // Seconds
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN BORAD_FAN_PIN  // Set a custom pin for the controller fan
...
#define CHAMBER_AUTO_FAN_PIN AUTO_FAN2_PIN
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   385        // The max position of the X2 carriage, typically also the home position
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_Y  33.6          // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT X2_MIN_POS
